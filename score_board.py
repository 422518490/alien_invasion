...
class ScoreBoard():
	...
	def prep_high_score(self):
		"""将最高得分渲染为图像"""
		high_score = int(round(self.status.score,-1));
	...
	def prep_level(self):
		"""将等级渲染为图像"""
		self.level_image = self.font.render(str(self.status.level),True,self.text_color,self.ai_setting.bg_color);
